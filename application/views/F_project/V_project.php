                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <div class="btn-group btn-group-md ">
                                                    ...
                                                    <a href="<?= base_url('Project/delete_project/' . $pro->id_project) ?>" class="btn btn-danger" title="hapus"><i class="fa-solid fa-trash-can" onclick="return confirm('Apakah anda yakin menghapus data ini?')"></i></a>
