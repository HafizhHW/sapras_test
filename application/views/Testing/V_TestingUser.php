             ...
             <div class="row mb-2">
                 ...
                 <div class="col-sm-6">
                     <ol class="breadcrumb float-sm-right">
                         <li class="breadcrumb-item"><a href="<?= base_url('User/ViewUser') ?>"><?= $title ?></a></li>
                                         ...
                                         <tr>
                                             ...
                                             <td>
                                                 <div class="btn-group btn-group-sm d-flex justify-content-center">
                                                     <a href="<?= base_url('User/delete_user/' . $usr->id_user) ?>" class="btn btn-danger" title="hapus" id="btn-hapus"><i class="fas fa-trash"></i></a>
                                                 </div>
                                             </td>
                                         </tr>
                                     <?php endforeach ?>
