                ...
                <div class="col-md-8">
                    ...
                    <div class="card card-primary">
                        ...
                        <?php foreach ($arsip as $a) { ?>
                            <?php echo form_open_multipart('Arsip/update_act/' . $a->id_arsip); ?>
                            <div class="card-body">
                                <div class="form-group">
                                    <input type="hidden" name="id_arsip" class="form-control" value="<?= $a->id_arsip ?>">
                                </div>

                                <div class="form-group">
                                    <label class="control-label col-xs-3 required"> Nama Project </label>
                                    <div class="col-xs-8">
                                        <input type="text" name="nm_arsip" class="form-control" value="<?= $a->nm_arsip ?>">
                                        <div class="alert-danger"><?php echo form_error('nm_arsip'); ?></div>
                                    </div>
                                </div>
